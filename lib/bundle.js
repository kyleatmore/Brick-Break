...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    value: function allObjects() {
      var objects = this.bricks.concat(this.paddle, this.ball, this.powerups);
      return objects;
    }
  }, {
    key: 'addBall',
    ...
    value: function spawnPowerup(brick) {
      this.powerups.push(new _powerup2.default(brick, this, this.ctx));
    }
  }, {
    key: 'expandPaddle',
...
var Powerup = function (_MovingObject) {
  ...
  function Powerup(brick, game, ctx) {
    ...
    _this.image.src = "./assets/images/expand_powerup.png";
    _this.ctx = ctx;
